...
from .backbones.videomamba import build_videomamba, build_clip
...
class UMT_VIDEOMAMBA(nn.Module):
    ...
    def encode_teacher(self, image):
        ...
        with torch.no_grad():
            ...
            # add cls
            mask = torch.cat((torch.zeros(B, 1).to(torch.bool).cuda(), mask.cuda()), dim=1)
    ...
    def build_vision_encoder(self):
        ...
        tublet_size = self.config.model.vision_encoder.kernel_size
