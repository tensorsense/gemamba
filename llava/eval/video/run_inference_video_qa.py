...
def get_model_output(model, video_processor, tokenizer, video, qs, args):
    ...
    # outputs = outputs.strip()
    # print(outputs)
    return outputs, len(output_ids[0]), proctime
    ...
    for sample in tqdm(gt_questions):
        ...
        for fmt in tqdm(video_formats):  # Added this line
            ...
            if os.path.exists(temp_path):
                ...
                output, ntokens, proctime = get_model_output(model, processor, tokenizer, video_path, question, args)
                sample_set['pred'] = output
                sample_set['ntokens'] = ntokens
                sample_set['proctime'] = proctime
